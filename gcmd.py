...
path1 = '.'
if(path.exists("ral_gcmd.txt")):
    os.remove("ral_gcmd.txt")
fo = open("ral_gcmd.txt", "w+")
...
if(path.exists("ral_gcmd_counts_levels.txt")):
    os.remove("ral_gcmd_counts_levels.txt")

sys.stdout = open("ral_gcmd_counts_levels.txt", "w")
